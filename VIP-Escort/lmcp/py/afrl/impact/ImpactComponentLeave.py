...
class ImpactComponentLeave(LMCPObject.LMCPObject):
    ...
    def __init__(self):
        ...
        self.FULL_LMCP_TYPE_NAME = "afrl.impact.ImpactComponentLeave"
    ...
    def toDict(self):
        ...
        if ("IMPACT" is None) or ("IMPACT" is ""): # this should never happen
            ...
            d["datatype"] = str("DEBUG_PROBLEM_HERE" + "/ImpactComponentLeave")
            d["datastring"] = str(m)
        else:
            d['datatype'] = str("IMPACT" + "/ImpactComponentLeave")
            d['datastring'] = str(m)
        return d
