    ...
    def unpackFromXMLNode(self, el, seriesFactory):
        ...
        for e in el.childNodes:
            if e.nodeType == xml.dom.Node.ELEMENT_NODE:
                if e.localName == "Key" and len(e.childNodes) > 0 :
                    self.Key = str(e.childNodes[0].nodeValue)
                elif e.localName == "Value" and len(e.childNodes) > 0 :
                    self.Value = str(e.childNodes[0].nodeValue)
