...
class QuadcopterVehicleState(EntityState.EntityState):

    def __init__(self):
        EntityState.EntityState.__init__(self)
        self.LMCP_TYPE = 8
        self.SERIES_NAME = "VEHICLES"
        self.FULL_LMCP_TYPE_NAME = "afrl.vehicles.QuadcopterVehicleState"
    ...
    def toString(self):
        ...
        buf += "From QuadcopterVehicleState:\n"
    ...
    def toDict(self):
        ...
        if ("VEHICLES" is None) or ("VEHICLES" is ""): # this should never happen
            ...
            d["datatype"] = str("DEBUG_PROBLEM_HERE" + "/QuadcopterVehicleState")
            d["datastring"] = str(m)
        else:
            d['datatype'] = str("VEHICLES" + "/QuadcopterVehicleState")
            d['datastring'] = str(m)
        return d
    ...
    def toXMLStr(self, ws):
        str = ws + '<QuadcopterVehicleState Series="VEHICLES" >\n';
        #str +=EntityState.EntityState.toXMLMembersStr(self, ws + "  ")
        str += self.toXMLMembersStr(ws + "  ")
        str += ws + "</QuadcopterVehicleState>\n";
        return str
